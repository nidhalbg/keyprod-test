...
export class Config {
  ...
  'jhipster.mail.from' = 'todos@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'todos API';
  'jhipster.swagger.description' = 'todos API documentation';
  ...
  'eureka.instance.appname' = 'todos';
  'eureka.instance.instanceId' = 'todos:${random.value}';
